 ...
 *          Usually "Software\Waterfox Limited\${AppName}"
 * @param   _PREF ($R2)
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\Waterfox Limited).
 * @return  _RESULT
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically this will be Software\Waterfox Limited\App Name).
 * @return  _RESULT
 ...
 *
 * @param   _KEY
 *          The registry subkey (typically Software\Waterfox Limited\App Name).
 * @return  _RESULT
 ...
 * @param   _KEY ($R1)
 *          The registry subkey
 *          (typically this will be Software\Waterfox Limited\${AppName}).
 */
!macro RegCleanPrefs
 ...
 *          be stored. ex: "Software\Waterfox Limited\Firefox\TaskBarIDs"
