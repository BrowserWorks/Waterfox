...
add_task(async function setup_preferences() {
  await SpecialPowers.pushPrefEnv({
    set: [
      ["browser.policies.alternateGPO", "SOFTWARE\\Waterfox Limited\\PolicyTesting"],
    ],
  });
});
...
add_task(async function test_gpo_policies() {
  ...
  let regLocation =
    "SOFTWARE\\Waterfox Limited\\PolicyTesting\\Waterfox Limited\\" + Services.appinfo.name;
  ...
  wrk.removeChild("PolicyTesting\\Waterfox Limited\\" + Services.appinfo.name);
