...
add_task(async function setup_preferences() {
  await SpecialPowers.pushPrefEnv({
    set: [
      ["browser.policies.alternateGPO", "SOFTWARE\\Waterfox Ltd.\\PolicyTesting"],
    ],
  });
});
...
add_task(async function test_gpo_policies() {
  ...
  let regLocation =
    "SOFTWARE\\Waterfox Ltd.\\PolicyTesting\\Waterfox Ltd.\\" + Services.appinfo.name;
  ...
  wrk.removeChild("PolicyTesting\\Waterfox Ltd.\\" + Services.appinfo.name);
