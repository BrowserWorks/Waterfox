...
var SafeBrowsing = {
  ...
  addMozEntries() {
    ...
    const trackerURLs = ["trackertest.org/", "itisatracker.org/"];
    ...
    let db = Cc["@mozilla.org/url-classifier/dbservice;1"].getService(
    ...
    try {
      let tables =
        "test-malware-simple,test-phish-simple,test-unwanted-simple,test-harmful-simple,test-track-simple,test-trackwhite-simple,test-block-simple";
