...
class GCSchedulingTunables
{
     ...
     */
    MainThreadData<bool> refreshFrameSlicesEnabled_;
...
class MemoryCounter
{
    ...
    js::MainThreadData<size_t> maxBytes_;
...
class GCRuntime
{
  ...
  private:
     ...
     */
    MainThreadData<Arena*> arenasAllocatedDuringSweep;
     ...
     */
    MainThreadData<bool> interFrameGC;
