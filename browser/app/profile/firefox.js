...
pref("browser.newtabpage.activity-stream.telemetry.ping.endpoint", "", locked);
...
//Telemetry created by virtue of having updated an older profile disabled.
pref("app.update.lastUpdateTime.telemetry_modules_ping", "", locked);
pref("toolkit.telemetry.previousBuildID", "", locked);
pref("browser.cache.disk.telemetry_report_ID", "", locked);
