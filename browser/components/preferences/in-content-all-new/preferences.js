...
function init_all() {
  ...
  register_module("paneTabs", gTabsPane);
  register_module("paneWebpages", gWebpagesPane);
  register_module("paneAppearance", gAppearancePane);
  register_module("paneDownloads", gDownloadsPane);
  register_module("paneHome", gHomePane);
  register_module("paneSearch", gSearchPane);
  register_module("panePrivacy", gPrivacyPane);
  register_module("paneContainers", gContainersPane);
  register_module("paneAll", gAllPane);

  document.querySelector('#category-all').addEventListener("click", gAllPane.initAll);
