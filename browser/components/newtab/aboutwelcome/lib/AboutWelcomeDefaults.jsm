...
const MR_ABOUT_WELCOME_DEFAULT = {
  ...
  backdrop:
    "32px 32px/calc(2*32px) calc(2*32px) conic-gradient(at calc(500%/6) 50%,#71a9f7 25%,#0000 0),0 0/calc(2*32px) calc(2*32px) conic-gradient(at calc(500%/6) 50%,#71a9f7 25%,#0000 0), 32px 32px/calc(2*32px) calc(2*32px) conic-gradient(at calc(200%/3) 50%,#6092ff 25%,#0000 0),0 0/calc(2*32px) calc(2*32px) conic-gradient(at calc(200%/3) 50%,#6092ff 25%,#0000 0), repeating-conic-gradient(#c6d8ff 0 25%,#0000 0 50%) 0 0/calc(2*32px) calc(2*32px), linear-gradient(#c6d8ff calc(100%/3),#6092ff 0 calc(200%/3),#71a9f7 0) 0 0/32px 32px",
  screens: [
    {
      id: "AW_WELCOME_BACK",
