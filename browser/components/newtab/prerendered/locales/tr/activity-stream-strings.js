...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox giriş sayfası içeriği",
  "prefs_home_description": "Waterfox giriş sayfasında görmek istediğiniz içerikleri seçin.",
  "prefs_content_discovery_description": "Waterfox giriş sayfasındaki içerik keşfi özelliği, internetteki kaliteli ve ilginizi çekebilecek yazıları keşfetmenizi sağlar.",
  ...
  "prefs_snippets_description": "Mozilla ve Waterfox’tan haberler",
  ...
  "firstrun_title": "Waterfox’u yanınızda taşıyın",
  "firstrun_content": "Yer imlerinizi, geçmişinizi, parolalarınızı ve diğer ayarlarınızı tüm cihazlarınızda kullanabilirsiniz.",
  "firstrun_learn_more_link": "Waterfox Hesapları hakkında bilgi alın",
  "firstrun_form_header": "Waterfox Sync’e devam etmek için",
