...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Начална страница на Waterfox",
  "prefs_home_description": "Изберете съдържанието, което искате да виждате на началната страница на Waterfox.",
  ...
  "prefs_snippets_description": "Новости от Mozilla и Waterfox",
  ...
  "firstrun_title": "Вземете Waterfox с вас",
  "firstrun_content": "Вземете своите отметки, история, пароли и всички други настройки на всички ваши устройства.",
  "firstrun_learn_more_link": "Научете повече за Waterfox Accounts",
  "firstrun_form_header": "Въведете своята ел. поща,",
  "firstrun_form_sub_header": "за да продължите към Waterfox Sync",
