...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Хатні экран Waterfox",
  "prefs_home_description": "Выберыце пажаданае змесціва для хатняга экрана Waterfox.",
  "prefs_content_discovery_description": "Выяўленне змесціва на хатняй старонцы Waterfox дазволіць вам знаходзіць высакаякасныя рэлевантныя артыкулы з усяго сеціва.",
  ...
  "prefs_snippets_description": "Абнаўленні ад Mozilla і Waterfox",
  ...
  "firstrun_title": "Вазьміце Waterfox з сабой",
  "firstrun_content": "Атрымайце доступ да вашых закладак, гісторыі, пароляў і іншых налад на ўсіх вашых прыладах.",
  "firstrun_learn_more_link": "Даведайцеся больш пра ўліковыя запісы Waterfox",
  "firstrun_form_header": "Увядзіце сваю электронную пошту",
  "firstrun_form_sub_header": "каб прадоўжыць з Waterfox Sync.",
