...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox үй парағы құрамасы",
  "prefs_home_description": "Waterfox үй парағында қандай құраманы көргіңіз келетінді таңдаңыз.",
  "prefs_content_discovery_description": "Waterfox үй парағында құраманы табу сізге интернеттен жоғары сапалы, релевантты мақалаларды табуға көмектеседі.",
  ...
  "prefs_snippets_description": "Mozilla және Waterfox жаңалықтары",
  ...
  "firstrun_title": "Waterfox-ты өзіңізбен бірге алыңыз",
  "firstrun_content": "Бетбелгілер, тарих, парольдер және т.б. баптауларды құрылғыларыңыздың барлығында алыңыз.",
  "firstrun_learn_more_link": "Waterfox тіркелгілері туралы көбірек білу",
  "firstrun_form_header": "Эл. поштаны енгізіңіз",
  "firstrun_form_sub_header": "Waterfox синхрондауына жалғастыру үшін.",
