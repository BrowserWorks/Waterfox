...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Innehåll Waterfox-startskärm",
  "prefs_home_description": "Välj vilket innehåll du vill ha på din startskärm i Waterfox.",
  "prefs_content_discovery_description": "Content Discovery på Waterfox startsida låter dig upptäcka högkvalitativa, relevanta artiklar från hela webben.",
  ...
  "prefs_snippets_description": "Uppdateringar från Mozilla och Waterfox",
  ...
  "firstrun_title": "Ta med dig Waterfox",
  "firstrun_content": "Få dina bokmärken, historik, lösenord och andra inställningar på alla dina enheter.",
  "firstrun_learn_more_link": "Lär dig mer om Waterfox-konton",
  "firstrun_form_header": "Ange din e-postadress",
  "firstrun_form_sub_header": "för att fortsätta till Waterfox Sync.",
