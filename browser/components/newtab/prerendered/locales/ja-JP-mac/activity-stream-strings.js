...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox Home コンテンツ",
  "prefs_home_description": "Waterfox Home に表示するコンテンツを選びましょう。",
  "prefs_content_discovery_description": "Waterfox Home のコンテンツディスカバリーは関連性の高い優れた記事をウェブ上から発見できます。",
  ...
  "prefs_snippets_description": "Mozilla と Waterfox に関する最新情報",
  ...
  "firstrun_title": "Waterfox をあなたとともに",
  "firstrun_content": "すべての端末で、ブックマーク、履歴、パスワード、その他の設定を取得できます。",
  "firstrun_learn_more_link": "Waterfox Accounts に関する詳細情報",
  "firstrun_form_header": "メールアドレスを入力してください",
  "firstrun_form_sub_header": "Waterfox Sync の利用を続けるために必要です",
