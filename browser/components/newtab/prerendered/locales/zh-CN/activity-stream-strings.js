...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox 主页内容",
  "prefs_home_description": "选择要在您的 Waterfox 主页上显示的版块。",
  "prefs_content_discovery_description": "Waterfox 主页中的“内容发现”可助您发现网络上的高品质、有价值的文章。",
  ...
  "prefs_snippets_description": "来自 Mozilla 和 Waterfox 的快讯",
  ...
  "firstrun_title": "随身携带 Waterfox",
  "firstrun_content": "在您的所有设备上获取您的书签、历史记录、密码以及其他设置。",
  "firstrun_learn_more_link": "详细了解 Waterfox 账户",
  "firstrun_form_header": "请输入您的电子邮箱",
  "firstrun_form_sub_header": "继续使用 Waterfox 同步服务。",
