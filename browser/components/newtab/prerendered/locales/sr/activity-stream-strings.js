...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Садржај Waterfox почетне странице",
  "prefs_home_description": "Изаберите садржај који желите видети на вашој Waterfox почетној страници.",
  "prefs_content_discovery_description": "Откривање садржаја на Waterfox почетној вам омогућава да добијете веома квалитетне и вама значајне чланке са целог веба.",
  ...
  "prefs_snippets_description": "Новости од Mozilla-е и Waterfox-а",
  ...
  "firstrun_title": "Понесите Waterfox са собом",
  "firstrun_content": "Имајте све забелешке, историјат, лозинке и друге поставке на свим вашим уређајима.",
  "firstrun_learn_more_link": "Сазнајте више о Waterfox Accounts",
  "firstrun_form_header": "Унесите вашу адресу е-поште",
  "firstrun_form_sub_header": "да бисте наставили на Waterfox Sync.",
