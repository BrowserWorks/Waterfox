...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Домашняя страница Waterfox",
  "prefs_home_description": "Выберите, какое содержимое вы хотите видеть на домашней странице Waterfox.",
  "prefs_content_discovery_description": "Обнаружение содержимого на домашней странице Waterfox позволит вам находить высококачественные релевантные статьи со всего Интернета.",
  ...
  "prefs_snippets_description": "Обновления от Mozilla и Waterfox",
  ...
  "firstrun_title": "Возьмите Waterfox с собой",
  "firstrun_content": "Получите доступ к вашим закладкам, истории, паролям и другим параметрам на всех ваших устройствах.",
  "firstrun_learn_more_link": "Узнайте больше об Аккаунтах Waterfox",
  "firstrun_form_header": "Введите ваш адрес электронной почты",
  "firstrun_form_sub_header": "чтобы продолжить использовать синхронизацию Waterfox.",
