...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox 首頁內容",
  "prefs_home_description": "選擇要在您的 Waterfox 首頁顯示哪些內容。",
  "prefs_content_discovery_description": "Waterfox Home 的內容探索功能可隨您上網，為您尋找高品質而與您有關的文章。",
  ...
  "prefs_snippets_description": "來自 Mozilla 及 Waterfox 的大小事",
  ...
  "firstrun_title": "Waterfox 隨身帶著走",
  "firstrun_content": "在您的各種裝置上同步書籤、瀏覽紀錄、登入資訊及其他設定。",
  "firstrun_learn_more_link": "了解 Waterfox Accounts 的更多資訊",
  "firstrun_form_header": "輸入您的電子郵件地址",
  "firstrun_form_sub_header": "繼續前往 Waterfox Sync",
