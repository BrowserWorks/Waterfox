...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfox 홈 콘텐츠",
  "prefs_home_description": "Waterfox 홈 화면에 나올 콘텐츠를 선택하세요.",
  "prefs_content_discovery_description": "Waterfox 홈의 콘텐츠 탐색 기능을 사용하면 웹에 있는 고품질의 관련 문서를 탐색할 수 있습니다.",
  ...
  "prefs_snippets_description": "Mozilla와 Waterfox 소식",
  ...
  "firstrun_title": "Waterfox와 함께 하세요",
  "firstrun_content": "즐겨찾기와 방문기록, 비밀번호, 다른 설정을 모든 기기에서 사용해 보세요.",
  "firstrun_learn_more_link": "Waterfox 계정 자세히 알아보기",
  "firstrun_form_header": "이메일을 입력",
  "firstrun_form_sub_header": "해서 Waterfox Sync 사용",
