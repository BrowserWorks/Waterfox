...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Waterfoxin aloitussivun sisältö",
  "prefs_home_description": "Valitse Waterfoxin aloitussivulle haluamasi sisältö.",
  "prefs_content_discovery_description": "Waterfoxin aloitussivun sisällön esittely näyttää laadukkaita ja olennaisia artikkeleita ympäri verkkoa.",
  ...
  "prefs_snippets_description": "Päivitykset Mozillalta ja Waterfoxilta",
  ...
  "firstrun_title": "Ota Waterfox matkalle mukaan",
  "firstrun_content": "Käytä kirjanmerkkejä, historiaa, salasanoja ja muita asetuksia kaikilla laitteillasi.",
  "firstrun_learn_more_link": "Lue lisää Waterfox-tilistä",
  "firstrun_form_header": "Kirjoita sähköpostisi",
  "firstrun_form_sub_header": "jatkaaksesi Waterfox Sync -palveluun.",
