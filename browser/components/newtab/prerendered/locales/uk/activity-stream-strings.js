...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Домівка Waterfox",
  "prefs_home_description": "Оберіть бажаний вміст для показу в домівці Waterfox.",
  "prefs_content_discovery_description": "Огляд вмісту в домівці Waterfox дозволяє вам знаходити високоякісні, цікаві статті з усього інтернету.",
  ...
  "prefs_snippets_description": "Оновлення від Mozilla та Waterfox",
  ...
  "firstrun_title": "Візьміть Waterfox з собою",
  "firstrun_content": "Ваші закладки, історія, паролі та інші налаштування на всіх ваших пристроях.",
  "firstrun_learn_more_link": "Дізнайтеся більше про обліковий запис Waterfox",
  "firstrun_form_header": "Введіть свою адресу е-пошти",
  "firstrun_form_sub_header": "для продовження в Синхронізації Waterfox.",
