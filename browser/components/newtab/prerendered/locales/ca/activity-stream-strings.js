...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Contingut d'inici del Waterfox",
  "prefs_home_description": "Trieu el contingut que voleu a la pantalla d'inici del Waterfox.",
  "prefs_content_discovery_description": "El descobriment de contingut en la pàgina d'inici del Waterfox us permet descobrir articles de gran qualitat i rellevants de tot el web.",
  ...
  "prefs_snippets_description": "Actualitzacions de Mozilla i del Waterfox",
  ...
  "firstrun_title": "El vostre Waterfox, a tot arreu",
  ...
  "firstrun_learn_more_link": "Més informació sobre el Compte del Waterfox",
  "firstrun_form_header": "Introduïu la vostra adreça electrònica",
  "firstrun_form_sub_header": "per continuar al Waterfox Sync.",
