...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "Περιεχόμενο αρχικής σελίδας Waterfox",
  "prefs_home_description": "Επιλέξτε τι περιεχόμενο θέλετε στην αρχική σελίδα του Waterfox σας.",
  "prefs_content_discovery_description": "Η ανακάλυψη περιεχομένου στην Αρχική Waterfox σάς επιτρέπει να ανακαλύψετε υψηλής ποιότητας, σχετικά άρθρα από όλο τον ιστό.",
  ...
  "prefs_snippets_description": "Ενημερώσεις από τη Mozilla και το Waterfox",
  ...
  "firstrun_title": "Πάρτε το Waterfox μαζί σας",
  ...
  "firstrun_learn_more_link": "Μάθετε περισσότερα για τους Λογαριασμούς Waterfox",
  "firstrun_form_header": "Εισάγετε το email σας",
  "firstrun_form_sub_header": "για να συνεχίσετε στο Waterfox Sync.",
