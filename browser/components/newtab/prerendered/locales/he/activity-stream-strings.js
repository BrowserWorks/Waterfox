...
window.gActivityStreamStrings = {
  ...
  "prefs_home_header": "תוכן מסך הבית של Waterfox",
  "prefs_home_description": "בחירת תוכן שיוצג במסך הבית של Waterfox.",
  "prefs_content_discovery_description": "גילוי תוכן במסך הבית של Waterfox מאפשר לך לגלות מאמרים רלוונטים ובאיכות גבוהה מכל רחבי הרשת.",
  ...
  "prefs_snippets_description": "עדכונים מ־Mozilla ו־Waterfox",
  ...
  "firstrun_title": "Waterfox אתך בדרכים",
  "firstrun_content": "לקחת את המועדפים, ההיסטוריה, הססמאות והגדרות נוספות בכל ההתקנים שלך.",
  "firstrun_learn_more_link": "מידע נוסף על חשבונות Waterfox",
  "firstrun_form_header": "נא להקליד את כתובת הדוא״ל שלך",
  "firstrun_form_sub_header": "כדי להמשיך אל Waterfox Sync.",
