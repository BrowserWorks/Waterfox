...
Section "Uninstall"
  ...
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-1.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-2.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-3.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-4.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-5.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-6.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-7.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-8.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-9.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-10.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-install.log"
  Call un.RenameDelete
  Push "$APPDATA\WaterfoxLimited\logs\maintenanceservice-uninstall.log"
  Call un.RenameDelete
  RMDir /REBOOTOK "$APPDATA\WaterfoxLimited\logs"
  RMDir /REBOOTOK "$APPDATA\WaterfoxLimited"
