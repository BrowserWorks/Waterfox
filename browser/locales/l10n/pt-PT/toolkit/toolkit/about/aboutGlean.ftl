...
about-glean-description = O <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> é uma biblioteca de recolha de dados utilizada nos produtos da Waterfox. Esta página é para programadores e técnicos de teste que necessitam de <a data-l10n-name="fog-debug-doc-link">configurar o estado de depuração e registo no Glean SDK</a>.
