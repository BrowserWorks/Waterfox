...
consider-bcc-notification = Os { $count } destinatários em Para e Cc podem ver os endereços entre si. Pode evitar a divulgação dos destinatários utilizando o Bcc.
