...
changed-desc-profiles = Esta instalação do { -brand-short-name } tem um novo perfil. Um perfil é um conjunto de arquivos onde o { -brand-product-name } salva informações como dados de e-mails, senhas, preferências e catálogos de endereços.
