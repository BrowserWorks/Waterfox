...
about-glean-description = De <a data-l10n-name="glean-sdk-doc-link">Glean-SDK</a> is een bibliotheek voor gegevensverzameling die wordt gebruikt in Waterfox-producten. Deze pagina is bedoeld voor ontwikkelaars en testers die <a data-l10n-name="fog-debug-doc-link">de debugging- en logboekstatus in de Glean-SDK</a> moeten configureren.
