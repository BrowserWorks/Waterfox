...
restart-show-button =
    .label = Wyświetlaj przycisk na panelu
restart-purge-cache =
...
statusbar-enabled =
    .label = Wyświetl pasek stanu
statusbar-show-links =
    .label = Wyświetlaj adres URL na pasku stanu
statusbar-contrast-text =
    .label = Kontrastowy kolor adresu URL na pasku stanu
bookmarks-bar-position-header = Pozycja paska zakładek
