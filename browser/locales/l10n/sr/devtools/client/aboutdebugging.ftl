...
about-debugging-browser-version-too-old-fennec = Ова Waterfox верзија не може да уклања грешке за Waterfox за Android (68). Препоручујемо вам да на телефон инсталирате Waterfox за Android Nightly за тестирање. <a>Више детаља</a>
