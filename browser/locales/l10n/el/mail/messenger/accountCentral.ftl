...
email-description = Το { -brand-short-name } σας επιτρέπει να συνδεθείτε με τον υπάρχοντα λογαριασμό email σας για να διαβάζετε τα emails σας εύκολα και αποδοτικά μέσα από την εφαρμογή.

calendar-label = Ημερολόγιο
    .aria-label = Δημιουργία νέου ημερολογίου
calendar-description = Το { -brand-short-name } σας επιτρέπει να διαχειρίζεστε γεγονότα και να παραμένετε οργανωμένοι. Η σύνδεση σε ένα απομακρυσμένο ημερολόγιο θα διατηρήσει συγχρονισμένα τα συμβάντα σας σε όλες τις συσκευές σας.

chat-label = Συνομιλία
    .aria-label = Σύνδεση στο λογαριασμό συνομιλιών σας
chat-description = Το { -brand-short-name } σας επιτρέπει να συνδεθείτε σε πολλαπλούς λογαριασμούς ανταλλαγής άμεσων μηνυμάτων, προσφέροντας υποστήριξη για διάφορες πλατφόρμες.

filelink-label = Filelink
    .aria-label = Ρύθμιση Filelink
filelink-description = Το { -brand-short-name } σας επιτρέπει να ρυθμίσετε ένα βολικό λογαριασμό cloud για συνδέσμους αρχείων, ώστε να αποστέλλετε εύκολα μεγάλα συνημμένα αρχεία.

addressbook-label = Ευρετήριο διευθύνσεων
    .aria-label = Δημιουργία νέου ευρετηρίου διευθύνσεων
addressbook-description = Το { -brand-short-name } σας επιτρέπει να οργανώσετε όλες τις επαφές σας σε ένα ευρετήριο διευθύνσεων. Μπορείτε επίσης να συνδεθείτε σε ένα απομακρυσμένο ευρετήριο διευθύνσεων για να διατηρήσετε σε συγχρονισμό όλες τις επαφές σας.

feeds-label = Ροές
    .aria-label = Σύνδεση στις ροές
feeds-description = Το { -brand-short-name } σας επιτρέπει να συνδεθείτε σε ροές RSS/Atom για να λαμβάνετε ειδήσεις και ενημερώσεις από παντού.

newsgroups-label = Ομάδες συζήτησης
    .aria-label = Σύνδεση σε ομάδα συζήτησης
newsgroups-description = Το { -brand-short-name } σας επιτρέπει να συνδεθείτε στις αγαπημένες ομάδες συζήτησής σας.

import-title = Εισαγωγή από άλλο πρόγραμμα
import-paragraph = Το { -brand-short-name } σας επιτρέπει να εισάγετε μηνύματα email, καταχωρήσεις ευρετηρίων διευθύνσεων, συνδρομές ροών, προτιμήσεις ή/και φίλτρα από άλλα προγράμματα email και συνηθισμένες μορφές ευρετηρίων διευθύνσεων.
