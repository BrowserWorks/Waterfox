...
cookie-tab-title = Cookies καταγραφής μεταξύ ιστοσελίδων
cookie-tab-content = Αυτά τα cookies σάς ακολουθούν από ιστοσελίδα σε ιστοσελίδα για να συλλέξουν δεδομένα για ό,τι κάνετε στο διαδίκτυο. Δημιουργούνται από τρίτους, όπως διαφημιστές και εταιρείες ανάλυσης. Η φραγή των cookies καταγραφής μεταξύ ιστοσελίδων μειώνει τον αριθμό των διαφημίσεων που σας παρακολουθούν. <a data-l10n-name="learn-more-link">Μάθετε περισσότερα</a>
...
bar-tooltip-cookie =
    .title = Cookies καταγραφής μεταξύ ιστοσελίδων
    .aria-label =
        { $count ->
            [one] { $count } cookie καταγραφής μεταξύ ιστοσελίδων ({ $percentage }%)
           *[other] { $count } cookies καταγραφής μεταξύ ιστοσελίδων ({ $percentage }%)
        }
bar-tooltip-tracker =
