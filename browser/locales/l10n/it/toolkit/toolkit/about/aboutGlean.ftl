...
about-glean-description = <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> è una libreria per la raccolta di dati utilizzata nei prodotti Waterfox. Questa pagina, dedicata a sviluppatori e tester, può essere utilizzata per <a data-l10n-name="fog-debug-doc-link">configurare debug e livello di log in Glean SDK</a>.
