...
fxa-qrcode-heading-phase1 = 1. 아직 설치하지 않았다면, <a data-l10n-name="connect-another-device">모바일 기기에 Waterfox를 설치하세요</a>.
fxa-qrcode-heading-phase2 = 2. 그런 다음 { -sync-brand-short-name }에 로그인하거나, Android에서 { -sync-brand-short-name } 설정 내에서 페어링 코드를 스캔하세요.
fxa-qrcode-heading-step1 = 1. 아직 설치하지 않았다면, <a data-l10n-name="connect-another-device">모바일 기기에 Waterfox를 설치하세요</a>.
fxa-qrcode-heading-step2 = 2. 모바일 기기에서 Waterfox를 여세요.
