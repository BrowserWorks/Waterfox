...
enable-about-debugging-message = Waterfox 개발자 도구로 WebExtensions이나 웹 Worker, Service Worker 등을 개발하고 디버깅하세요.
...
enable-common-message = Waterfox 개발자 도구는 브라우저를 보다 강력하게 제어할 수 있도록 기본적으로 비활성화되어 있습니다.
...
newsletter-email-placeholder =
    .placeholder = 이메일
newsletter-privacy-label = 저는 Waterfox가 <a data-l10n-name="privacy-policy">개인정보처리방침</a>에 설명된 대로 내 정보를 다루는 것에 동의합니다.
newsletter-subscribe-button = 구독
newsletter-thanks-title = 고맙습니다!
newsletter-thanks-message = 만약 이전에 Waterfox 관련 뉴스 레터 구독을 확인하지 않았다면 그렇게 해야 할 수 있습니다. 받은 편지함이나 스팸 필터에서 이메일을 확인하세요.
