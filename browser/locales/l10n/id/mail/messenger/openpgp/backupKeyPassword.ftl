...
set-password-backup-pw =
    .value = Kunci Rahasia cadangan sandi:
set-password-repeat-backup-pw =
    .value = Kunci Rahasia cadangan sandi (lagi):
set-password-reminder = <b> Penting! </b> Jika Anda lupa kunci rahasia sandi cadangan, Anda tidak akan dapat memulihkan cadangan ini nanti. Harap catat di tempat yang aman.
