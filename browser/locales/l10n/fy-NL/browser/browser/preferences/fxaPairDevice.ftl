...
fxa-qrcode-heading-step2 = 2. Iepenje Waterfox op jo mobile apparaat.
fxa-qrcode-heading-step3 = 3. Iepenje it <b>menu</b> (<img data-l10n-name="ios-menu-icon"/> of <img data-l10n-name="android-menu-icon"/>), tik op <img data-l10n-name="settings-icon"/> <b>Ynstellingen</b></b> en selektearje <b>Sync ynskeakelje</b>
