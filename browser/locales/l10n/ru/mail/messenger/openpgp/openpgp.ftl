...
import-key-file = Импорт ключевого файла OpenPGP
...
enig-content-note = *Вложения к этому сообщению не были подписаны или зашифрованы*
...
msg-compose-partially-encrypted-inlinePGP =
    Сообщение, на которое вы отвечаете, содержит как незашифрованные, так и зашифрованные части. Если отправитель изначально не смог расшифровать некоторые части сообщения, возможно, вы пропускаете конфиденциальную информацию, которую отправитель не смог первоначально расшифровать сам.
    Пожалуйста, рассмотрите возможность удаления всего цитируемого текста из вашего ответа данному отправителю.
...
quoted-printable-warn =
    Вы включили кодировку 'quoted-printable' для отправляемых сообщений. Это может привести к неправильной расшифровке и/или неправильной проверке вашего сообщения.
    Вы хотите отключить отправку сообщений в 'quoted-printable' сейчас?
minimal-line-wrapping =
    Вы установили перенос строки на { $width } символов. Для корректного шифрования и/или подписи это значение должно быть не менее 68.
    Вы хотите изменить перенос строки на 68 символов сейчас?
...
possibly-pgp-mime = Возможно, сообщение, зашифрованное или подписанное PGP/MIME; используйте функцию 'Расшифровать/Подтвердить' для проверки
cannot-send-sig-because-no-own-key = Невозможно подписать это сообщение, потому что вы ещё не настроили сквозное шифрования для <{ $key }>
cannot-send-enc-because-no-own-key = Невозможно отправить это сообщение в зашифрованном виде, потому что вы ещё не настроили сквозное шифрования для <{ $key }>
...
attachment-pgp-key =
    Открываемое вложение '{ $name }', вероятно, является ключевым файлом OpenPGP.
