...
openpgp-one-recipient-status-instruction2 = Чтобы получить его открытый ключ, импортируйте его из электронной почты, которую он отправил вам и которая его включает. Кроме того, вы можете попробовать найти его открытый ключ в каталоге.
