...
perftools-presets-firefox-platform-description = Configuración predeterminada recomendada para la depuración interna de la plataforma Waterfox.
perftools-presets-firefox-front-end-label = Interfaz de Waterfox
perftools-presets-firefox-front-end-description = Configuración predeterminada recomendada para la depuración interna de la interfaz de Waterfox.
perftools-presets-firefox-graphics-label = Gráficos de Waterfox
perftools-presets-firefox-graphics-description = Configuración predeterminada para la investigación de rendimiento gráfico de Waterfox.
