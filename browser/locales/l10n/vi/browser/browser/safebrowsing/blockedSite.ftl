...
safeb-blocked-malware-page-learn-more = Tìm hiểu thêm về nội dung web có hại bao gồm vi-rút và phần mềm độc hại khác và cách bảo vệ máy tính của bạn tại <a data-l10n-name='learn_more_link'>StopBadware.org</a>. Tìm hiểu thêm về cách { -brand-short-name } chống lừa đảo và phần mềm độc hại tại <a data-l10n-name='firefox_support'>support.mozilla.org</a>.
