...
about-debugging-browser-version-too-old-fennec = Ця версія Waterfox не може зневадити Waterfox для Android (68). Радимо встановити Waterfox для Android Nightly на ваш телефон для тестування. <a>Детальніше</a>
