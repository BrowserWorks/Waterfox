...
rights-intro-point-2 = Вам не передаються жодні права на торгову марку чи ліцензії на торгові марки Waterfox Ltd. або будь-якої сторони, включно та без обмежень на назву і логотип Waterfox. Додаткову інформацію щодо торгових марок можна знайти <a data-l10n-name="mozilla-trademarks-link">тут</a>.
