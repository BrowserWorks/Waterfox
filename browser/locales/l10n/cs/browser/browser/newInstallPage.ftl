...
changed-desc-dedicated = Aby bylo možné bezpečně používat více instalací prohlížeče Waterfox najednou (finální verzi, ESR, betaverzi, Waterfox Developer Edition a Nightly), používá nyní tato instalace vlastní profil. Automaticky už tedy nesdílí vaše uložená data s ostatními instalacemi.
