...
about-glean-description = A <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> egy a Waterfox termékeiben használt adatgyűjtő programkönyvtár. Ez a lap azoknak a fejlesztőknek és tesztelőknek szól, akiknek <a data-l10n-name="fog-debug-doc-link">hibakeresési és naplózási állapotot kell beállítaniuk a Glean SDK-ban</a>.
