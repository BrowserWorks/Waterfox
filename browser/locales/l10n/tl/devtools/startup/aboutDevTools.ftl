...
enable-title = Paganahin ang Waterfox Developer Tools
enable-inspect-element-title = I-enable ang Waterfox Developer Tools para magamit ang Inspect Element
enable-inspect-element-message = Suriin at baguhin ang HTML at CSS sa pamamagitan ng Inspector ng Developer Tools
enable-about-debugging-message = Gumawa at mag-debug ng mga WebExtension, web worker, service worker at iba pa gamit ang Waterfox Developer Tools.
...
enable-common-message = Ang mga Waterfox Developer Tool ay naka-disable sa simula para mas kontrolado mo ang iyong browser.
...
welcome-title = Maligayang pagdating sa Waterfox Developer Tools!
...
footer-message = Naghahanap ka ng higit pa sa mga Developer Tool? Tingnan mo ang Waterfox browser na sadyang ginawa para sa mga developer at modernong workflow.
