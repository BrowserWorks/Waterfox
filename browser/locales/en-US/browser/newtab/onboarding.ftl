...
onboarding-multistage-search-header = Add privacy to your <span data-l10n-name="zap">search</span>
...
onboarding-multistage-search-additional = Clicking the above will change the browser's default and homepage search boxes to Statepage.com.
onboarding-multistage-search-additional2 = This selection can be adjusted in the Settings menu.
onboarding-multistage-search-primary-button-label = Set Search to Private
onboarding-multistage-search-secondary-button-label = Continue with Default
