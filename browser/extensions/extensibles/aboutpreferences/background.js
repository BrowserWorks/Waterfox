...
const PrefsExt = {
  ...
  async init() {
    ...
    // // build tab bar position prefs
    // this.tabPositionContainer.forEach(item => {
    //   this.createAndPositionElement(item);
    //   if (item.attrs.label) {
    //     browser.extensibles.utils.append(item.attrs.id, item.attrs.label);
    //   }
    // });
    // this.tabPositionToggles.forEach(item => {
    //   this.createAndPositionElement(item);
    // });
    ...
    //   this.createAndPositionElement(item);
    // });
    // // build status bar prefs
    // this.statusContainer.forEach(item => {
    //   this.createAndPositionElement(item);
    //   if (item.attrs.label) {
    //     browser.extensibles.utils.append(item.attrs.id, item.attrs.label);
    //   }
    // });
    // this.statusPrefToggles.forEach(item => {
    //   this.createAndPositionElement(item);
    // });
    // // build bookmarks bar prefs
    // this.bookmarkContainer.forEach(item => {
    //   this.createAndPositionElement(item);
    //   if (item.attrs.label) {
    //     browser.extensibles.utils.append(item.attrs.id, item.attrs.label);
    //   }
    // });
    // this.bookmarkPrefToggles.forEach(item => {
    //   this.createAndPositionElement(item);
    // });
  },
