...
var EXPORTED_SYMBOLS = ["BlocklistClients"];
...
const PREF_SECURITY_SETTINGS_ONECRL_BUCKET =
  "services.settings.security.onecrl.bucket";
const PREF_SECURITY_SETTINGS_ONECRL_COLLECTION =
  "services.settings.security.onecrl.collection";
const PREF_SECURITY_SETTINGS_ONECRL_SIGNER =
  "services.settings.security.onecrl.signer";
const PREF_SECURITY_SETTINGS_ONECRL_CHECKED =
...
const PREF_BLOCKLIST_PINNING_COLLECTION =
  "services.blocklist.pinning.collection";
const PREF_BLOCKLIST_PINNING_CHECKED_SECONDS =
...
function initialize(options = {}) {
  ...
  OneCRLBlocklistClient = RemoteSettings(
    Services.prefs.getCharPref(PREF_SECURITY_SETTINGS_ONECRL_COLLECTION),
    {
      bucketNamePref: PREF_SECURITY_SETTINGS_ONECRL_BUCKET,
      lastCheckTimePref: PREF_SECURITY_SETTINGS_ONECRL_CHECKED,
      signerName: Services.prefs.getCharPref(
  ...
  PinningBlocklistClient = RemoteSettings(
