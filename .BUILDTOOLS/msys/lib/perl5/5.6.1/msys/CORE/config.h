 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.6.1/msys"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.6.1/msys"		/**/
...
#ifdef HAS_PHOSTNAME
#define PHOSTNAME "/c/WINNT/system32/hostname"	/* How to get the host name */
#endif
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.6.1/msys"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.6.1/msys"		/**/
 ...
 *	lib/lib.pm will automatically search in /usr/lib/perl5/site_perl/5.6.1/msys for older
