...
about-glean-description = <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> er et dataindsamlings-bibliotek, der anvendes i Waterfoxs produkter. Denne side er for udviklere og testere, der har brug for at <a data-l10n-name="fog-debug-doc-link">opsætte debugging og logning i Glean SDK</a>.
