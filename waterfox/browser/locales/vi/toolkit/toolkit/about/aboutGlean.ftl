...
about-glean-description = <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> là thư viện thu thập dữ liệu được sử dụng trong các sản phẩm của Waterfox. Trang này dành cho các nhà phát triển và người kiểm tra, những người cần <a data-l10n-name="fog-debug-doc-link">định cấu hình trạng thái gỡ lỗi và ghi nhật ký trong Glean SDK</a>.
