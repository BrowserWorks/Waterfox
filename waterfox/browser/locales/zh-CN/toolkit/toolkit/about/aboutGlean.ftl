...
about-glean-description = Waterfox 在产品中使用 <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> 收集数据。此页面向开发者和测试人员提供，用于<a data-l10n-name="fog-debug-doc-link">调试 Glean SDK 配置及记录状态</a>。
