...
theme-refresh =
    .label = Refresh Theme
enable-waterfox-theme =
    .label = Enable Waterfox theme customisation
...
square-menu-panel =
    .label = Square App Menu Panel
square-panel-item =
    .label = Square App Menu Item
square-menu-popup =
    .label = Square Context Menu Panel
square-menu-item =
    .label = Square Context Menu Item
square-field =
    .label = Square Entry Field
square-checkbox =
...
close-button-hover =
    .label = Only display close tab button on selected tab when many tabs are open
remove-panel-strip =
