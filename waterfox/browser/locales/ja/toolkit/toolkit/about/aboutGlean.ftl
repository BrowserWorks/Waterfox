...
about-glean-description = <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> は Waterfox 製品で利用されているデータ収集ライブラリーです。このページは、<a data-l10n-name="fog-debug-doc-link">Glean SDK でデバッグとログ状態の設定変更</a> を必要とする開発者およびテスター向けです。
