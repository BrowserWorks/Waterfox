...
rights-intro-point-2 = Nejsou vám však podstoupena žádná práva ani licence k ochranným známkám Waterfox Limited, či třetích stran, a to zejména k logu a názvu Waterfox. Podrobnější informace o ochranných známkách jsou dostupné <a data-l10n-name="mozilla-trademarks-link">zde</a>.
