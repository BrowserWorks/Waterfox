...
rights-intro-point-1 = { -brand-short-name } 是依照 <a data-l10n-name="mozilla-public-license-link">BrowserWorks 公眾授權條款</a>中的條件所提供給您的。這表示您可以使用、複製，或散布 { -brand-short-name } 給其他人。歡迎您自行修改 { -brand-short-name } 的原始碼以滿足您的需求；BrowserWorks 公眾授權條款也同時賦予您散佈修改版本的權利。
