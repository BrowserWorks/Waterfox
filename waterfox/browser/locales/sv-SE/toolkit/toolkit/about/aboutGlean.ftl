...
about-glean-description = <a data-l10n-name="glean-sdk-doc-link">Glean SDK</a> är ett datainsamlingsbibliotek som används i Waterfox-produkter. Denna sida är för utvecklare och testare som behöver <a data-l10n-name="fog-debug-doc-link">konfigurera felsökning och loggning i Glean SDK</a>.
