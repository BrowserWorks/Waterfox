...
const BrowserWindowWatcher = {
  ...
  installTabsSidebar(win) {
    ...
    elements.appendChild(element(document, XUL, 'vbox', {
      id:    'tabs-sidebar-box',
        ...
        element(document, XUL, 'toolbarbutton', {
          ...
          element(document, XUL, 'menupopup', {
            ...
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'gBrowser.reloadMultiSelectedTabs();', // same to #toolbar-context-reloadSelectedTab
            }),
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'gBrowser.reloadMultiSelectedTabs();', // same to #toolbar-context-reloadSelectedTabs
            }),
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'PlacesUIUtils.showBookmarkPagesDialog(PlacesCommandHook.uniqueSelectedPages);', // same to #toolbar-context-bookmarkSelectedTab
            }),
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'PlacesUIUtils.showBookmarkPagesDialog(PlacesCommandHook.uniqueSelectedPages);', // same to #toolbar-context-bookmarkSelectedTabs
            }),
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'gBrowser.selectAllTabs();', // same to #toolbar-context-selectAllTabs
            }),
            element(document, XUL, 'menuitem', {
              ...
              oncommand: 'undoCloseTab();', // same to #toolbar-context-undoCloseTab
            }),
            element(document, XUL, 'menuseparator'),
            element(document, XUL, 'menuitem', {
      ...
      case 'command':
        switch (event.target.id) {
          ...
          case 'tabs-sidebar-moreOptions':
            this.openOptions(event.target.defaultView, event.shiftKey);
            break;
        }
        break;
